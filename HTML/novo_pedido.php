...
-->
 ...
 <br>
          ...
          <center><div class="titulocontato">&nbsp;Novo pedido</div></center>
          <br>
          <div class="caixatextocontato"><p class="textocontato">Faça o login: </p>
            <div>
                <input type="checkbox" id="hamburger" name="hamburger" class="textopedido">
                <label for="Sanduiche">Hamburger</label><br>
                <label for="Qtd_hamburguer"class="textopedido">Quantidade</label>
                <input name="Qtdhamburguer" id="Qtdhamburguer" />
                <br>
                <input type="checkbox" id="xbacon" name="horns" class="textopedido">
                <label for="Sanduiche">X-bacon</label><br>
                <label for="Qtd_xbacon"class="textopedido">Quantidade</label>
                <input name="qtdxbacon" id="qtdxbacon" />
                <br>
                <input type="checkbox" id="xsalada" name="xsalada" class="textopedido">
                <label for="Sanduiche">X-salada</label><br>
                <label for="qtd_xsalada"class="textopedido">Quantidade</label>
                <input name="qtdxsalada" id="qtdxsalada" />
                <br>
                <input type="checkbox" id="xtudo" name="xtudo" class="textopedido">
                <label for="Sanduiche">X-tudo</label><br>
                <label for="qtd_xtudo"class="textopedido">Quantidade</label>
                <input name="qtdxtudo" id="qtdxtudo" />
              </div>
                                <p><button type="submit" class="botaologin">Enviar</button></p>
